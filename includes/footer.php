    ...
    <div class="container">
        <div class="row g-4 justify-content-between">
            ...
            <div class="col-lg-3 col-md-3 col-6">
                <h6 class="fw-semibold text-white mb-3">Kontak Info</h6>
                <ul class="list-unstyled small mb-0 d-flex flex-column gap-2 text-secondary">
                    <li class="d-flex align-items-center gap-2">
                        <i class="bi bi-geo-alt text-primary"></i> Indonesia
                    </li>
                    <li class="d-flex align-items-center gap-2">
                        <i class="bi bi-envelope text-primary"></i> heruperdanaaa@gmail.com
                    </li>
                </ul>
            </div>
        </div>
...
<!-- Bootstrap 5.3.3 Bundle JS CDN (termasuk Popper) -->
